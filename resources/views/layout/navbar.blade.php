    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
        ...
        <div class="flex items-center space-x-1 md:order-2 md:space-x-0 rtl:space-x-reverse">
            ...
            <button type="button" data-dropdown-toggle="language-dropdown-menu"
                class="inline-flex items-center justify-center px-4 text-sm font-medium text-gray-900 rounded-lg cursor-pointer dark:text-white dark:hover:text-white">
                <svg class="text-gray-800 rounded-full size-6 me-3 dark:text-white" aria-hidden="true"
                        ...
                        <li>
                            <button
                                ...
                                <div class="inline-flex items-center">
                                    <svg class="h-3.5 w-3.5 rounded-full me-2 text-gray-800 dark:text-white"
